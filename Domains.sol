...
contract Domains is ERC721URIStorage {
    ...
    require(domainsToOwner[name] == address(0));
    ...
    function getOwnerAddress(string calldata name) external view returns (address) {
        return domainsToOwner[name];
    }

    function setRecord(string calldata name, string calldata record) public {
        require (domainsToOwner[name] == msg.sender);
        records[name] = record;
    }
